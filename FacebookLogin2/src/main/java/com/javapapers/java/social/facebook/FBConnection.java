...
public class FBConnection {
	public static final String FB_APP_ID = "904509579758690";
	public static final String FB_APP_SECRET = "1904efa726a1874708323d4bb8beeffa";
	public static final String REDIRECT_URI = "http://localhost:8080/FacebookLogin2/fbhome";
	...
	public String getAccessToken(String code) {
		if ("".equals(accessToken)) {
			...
			accesscode1=accessToken;
		}
		accesscode1=accessToken;
		return accessToken;
	}

	public List<FacebookProfile> getFriendList(String access) {

		Facebook facebook = new FacebookTemplate(access);
	...
	public List<FacebookProfile> getFriendList1() {
		accesscode1=(String) session.getAttribute("accessT");
		
		Facebook facebook = new FacebookTemplate(accesscode1);
		List<FacebookProfile> friends = facebook.friendOperations().getFriendProfiles();
		for (FacebookProfile profile : friends) {
			System.out.println(profile.getId());
		}
